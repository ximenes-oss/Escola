    ...
    <div class="post-index">
        ...
        <header class="pt-5 border-bottom bg-light">
            <div class="container pt-md-1 pb-md-1">
                <h1 class="bd-title mt-4 font-weight-bold"><i class="fa fa-book-open" aria-hidden="true"></i> Noticia </h1>
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><router-link :to="{ name: 'post' }" class="text-decoration-none"><i class="fa fa-book-open"></i> Noticia</router-link></li>
        </ol>
        </nav>
        <!-- end breadcrumb -->
            ...
            <div class="row">
                ...
                <div v-else>
                    <div class="alert alert-danger">
                        DATA NOTICIA SEIDAUK IHA !
                    </div>
                </div>

                <div class="text-center" v-show="moreExists">
                    <button type="button" class="btn btn-primary btn-md" v-on:click="loadMore"><span class="fa fa-arrow-down"></span>VEJA TODOS</button>
                </div>
